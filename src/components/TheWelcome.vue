<template>
  <WelcomeItem>
    ...
    Vue’s
    <a href="https://vuejs.org/" target="_blank" rel="noreferrer noopener">official documentation</a>
  ...
  <WelcomeItem>
    ...
    <a href="https://vitejs.dev/guide/features.html" target="_blank" rel="noopener noreferrer">Vite</a>. The recommended
    IDE setup is <a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer">VSCode</a> +
  ...
  <WelcomeItem>
    ...
    <a href="https://github.com/vuejs/devtools" target="_blank" rel="noopener noreferrer">Vue Dev Tools</a>. If you need
  ...
  <WelcomeItem>
    ...
    <a href="https://chat.vuejs.org" target="_blank" rel="noopener noreferrer">Vue Land</a>, our official Discord
    server, or
    <a href="https://stackoverflow.com/questions/tagged/vue.js" target="_blank" rel="noopener noreferrer"
      >StackOverflow</a
    >. You should also subscribe to
    <a href="https://news.vuejs.org" target="_blank" rel="noopener noreferrer">our mailing list</a> and follow the
    official
